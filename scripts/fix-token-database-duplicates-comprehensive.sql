-- COMPREHENSIVE TOKEN DATABASE DUPLICATE FIX
-- August 22, 2025
-- Fixes duplicate issues across all token_erc* tables
...
-- ERC-4626 Strategy Params: Unique (token_id, strategy_name)
...
INSERT INTO audit_logs (
  ...
  'SYSTEM',
  'MEDIUM',
  'Applied comprehensive fix for token database duplicates across all ERC standards',
  jsonb_build_object(
    'script_name', 'fix-token-database-duplicates-comprehensive.sql',
    'execution_date', NOW(),
