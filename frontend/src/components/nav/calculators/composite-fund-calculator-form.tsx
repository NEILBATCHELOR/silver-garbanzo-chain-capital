/**
 * Composite Fund Calculator Form
 * Multi-asset fund NAV with portfolio-level risk and correlation analysis
 */
...
export function CompositeFundCalculatorForm({
  onSubmit,
  onReset,
  isLoading = false,
  initialData = {},
  ...
  const { 
    ...
    error: schemaError
  } = useCalculatorSchema('composite-funds')
...
export default CompositeFundCalculatorForm
