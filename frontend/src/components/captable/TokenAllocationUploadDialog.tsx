...
const TokenAllocationUploadDialog = ({
  ...
  const downloadTemplate = () => {
    const headers =
      "subscription_id,investor_name,investor_email,token_amount,wallet_address,token_type";
    const sampleData = [
      "SUB-12345,John Doe,john@example.com,10000,0x1234567890abcdef1234567890abcdef12345678,ERC-20",
      "SUB-67890,Jane Smith,jane@example.com,25000,0x2345678901abcdef2345678901abcdef23456789,",
    ];
