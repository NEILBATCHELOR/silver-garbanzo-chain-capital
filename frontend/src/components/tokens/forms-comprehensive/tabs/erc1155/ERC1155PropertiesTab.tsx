// ERC1155 Properties Tab Component
// Handles token_erc1155_properties table with multi-token configuration
...
import { ERC1155MasterConfigPanel } from '../../contracts/masters';
...
import {
  ...
  SupplyCapModuleConfigPanel,
  URIManagementModuleConfigPanel,
  GranularApprovalModuleConfigPanel
...
export const ERC1155PropertiesTab: React.FC<ERC1155PropertiesTabProps> = ({
  ...
  const enabledModulesCount = [
    ...
    supplyCapConfig.enabled,
    uriManagementConfig.enabled,
    granularApprovalConfig.enabled
    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'master' | 'extensions')}>
        ...
        <TabsContent value="master" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>ERC1155 Multi-Token Configuration</CardTitle>
            </CardHeader>
            <CardContent>
              <ERC1155MasterConfigPanel
                config={masterConfig}
        ...
        <TabsContent value="extensions" className="space-y-4">
          ...
          <Card>
            <CardHeader>
              <CardTitle>ERC1155-Specific Modules</CardTitle>
              <p className="text-sm text-muted-foreground">
                Extensions designed specifically for multi-token collections
              </p>
            </CardHeader>
            <CardContent className="space-y-6">
              <RoyaltyModuleConfigPanel
              ...
              <Separator />
              <SupplyCapModuleConfigPanel
                config={supplyCapConfig}
                onChange={setSupplyCapConfig}
                disabled={isSubmitting}
              />
              <Separator />
              <URIManagementModuleConfigPanel
                config={uriManagementConfig}
                onChange={setUriManagementConfig}
                disabled={isSubmitting}
              />
              <Separator />
              <GranularApprovalModuleConfigPanel
                config={granularApprovalConfig}
                onChange={setGranularApprovalConfig}
                disabled={isSubmitting}
              />
            </CardContent>
          </Card>
      ...
      <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
        <div className="flex items-center gap-2">
          <span className="text-sm text-muted-foreground">ERC-1155 Properties:</span>
          {isModified ? (
