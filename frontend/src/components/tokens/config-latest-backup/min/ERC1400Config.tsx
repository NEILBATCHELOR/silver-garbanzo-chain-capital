...
import { EnhancedInput } from "@/components/tokens/components/EnhancedInput";
                      ...
                      {(displayValues.partitions || []).map((partition, index) => (
                        <div key={index} className="p-3 border rounded-md">
                          ...
                          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                            ...
                            onChange={(value) => handlePartitionChange(index, "name", String(value))}
                            ...
                            onChange={(value) => handlePartitionChange(index, "amount", String(value))}
