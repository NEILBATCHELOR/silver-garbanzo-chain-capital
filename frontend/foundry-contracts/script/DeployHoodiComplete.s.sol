...
contract DeployHoodiComplete is Script {
    ...
    function configureSystem(address deployer) internal {
        ...
        // Grant REGISTRAR_ROLE to extension factories on ExtensionRegistry
        ...
        console.log(unicode"  ✅ Granted REGISTRAR_ROLE to 7 extension factories");
    ...
    function validateDeployment() internal view {
        ...
        console.log(unicode"  ✅ Factory registrations validated");
