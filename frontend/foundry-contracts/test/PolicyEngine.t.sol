...
contract PolicyEngineTest is Test {
    ...
    function setUp() public {
        ...
        // Deploy token with PolicyEngine
        token = new EnhancedERC20Token(
            "Test Token",
            "TEST",
            18,
            1000000 * 10**18,
    ...
    // Test: Mint exceeds max amount    function testMintExceedsMaxAmount() public {
        vm.startPrank(minter);
    ...
    function testCooldownPeriod() public {
        ...
        // Second operation immediately - should fail        (bool valid2, string memory reason2) = policyEngine.validateOperation(
            address(token),
            minter,
            "mint",
            1000 * 10**18
