...
export class XRPLFreezeService {
   ...
   */
  async enableGlobalFreeze(issuerWallet: Wallet): Promise<FreezeOperationResult> {
    const tx: AccountSet = {
   ...
   */
  async disableGlobalFreeze(issuerWallet: Wallet): Promise<FreezeOperationResult> {
    const tx: AccountSet = {
      TransactionType: 'AccountSet',
      Account: issuerWallet.address,
